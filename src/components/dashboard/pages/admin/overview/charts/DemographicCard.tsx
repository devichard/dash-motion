  ...
  return (
    <Card className="h-full flex flex-col">
      ...
      <CardContent className="pb-2 flex-1 flex flex-col">
        <div id="mapOne" className="mapOne map-btn flex-1 w-full">
          <CountryMap />
        </div>
      </CardContent>
        ...
        {/* <div className="flex w-full items-center justify-between">
          ...
          <div className="flex w-full max-w-[140px] items-center gap-3">
            <div className="relative block h-2 w-full max-w-[100px] rounded-sm bg-primary/20">
              <div className="absolute left-0 top-0 flex h-full w-[0%] items-center justify-center rounded-sm bg-primary text-xs font-medium text-white"></div>
            </div>
            <p>0%</p>
          </div>
        </div> */}
