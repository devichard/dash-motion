...
export default function CompanyIntro({ onNext, onPrev }: { onNext: () => void; onPrev: () => void }) {
  return (
    <div className="relative w-screen h-screen grid place-items-center overflow-hidden text-center px-4">
      <div className="max-w-md space-y-10">
        ...
        >
          Primeiro vamos cadastrar a sua empresa na nossa plataforma
        </motion.h1>
        <p className="text-muted-foreground text-lg">A seguir adicione os dados da sua empresa</p>
